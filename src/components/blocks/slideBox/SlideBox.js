    ...
    <div className="slideBox">
      <div className="container">
        <div className="slideBoxWrapper">
          ...
          <Profile class="heroAvatar" proffession="Фотограф" style={{width: "67px", height: "67px", }} likeStyle={{display: "none"}} styledText={{textAlign:"left", marginLeft:"10px"}} linkstyle={{textAlign:"left"}}/>
        </div>
      </div>
    </div>
  );
